...
export default function LooksGallery({ onLookClick }) {
  return (
    <section id="gallery-section" className="bg-[#f5f2ee] px-8 md:px-20 py-24 md:py-32">
      <motion.div initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:0.9,ease:[0.16,1,0.3,1]}} className="text-center mb-16">
        <span className="block text-[0.62rem] tracking-[0.35em] uppercase text-[#c9a96e] mb-4">הקולקציה</span>
        <h2 className="font-editorial text-[clamp(2rem,3.5vw,3rem)] font-light tracking-[0.02em] leading-[1.12] mb-4">
          צרי את <em className="italic">הלוק האישי שלך</em>
        </h2>
        <p className="text-[0.8rem] font-light leading-[1.8] text-mid max-w-md mx-auto">
          מהצהרות ערב דרמטיות עד זוהר יומי קל — כל לוק, לרכישה מלאה.
        </p>
      </motion.div>
